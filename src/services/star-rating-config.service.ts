 ...
 */
export class StarRatingConfigService implements IStarRatingConfig {

  _classEmpty: string = "default-star-empty-icon";
  ...
  private _classHalf: string = "default-star-half-icon";
  ...
  private _classFilled: string = "default-star-filled-icon";
  ...
  private _assetsPath: string = "assets/images/";
  ...
  private _svgPath: string = this.assetsPath + "star-rating.icons.svg";
  ...
  private _svgEmptySymbolId: string = "star-empty";
  ...
  private _svgHalfSymbolId: string = "star-half";
  ...
  private _svgFilledSymbolId: string = "star-filled";
